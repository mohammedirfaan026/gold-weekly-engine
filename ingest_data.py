...
def main():
    parser = argparse.ArgumentParser(description="Ingest all market, macro, COT, ETF, and event data.")
    ...
    # 1. Market Data
    print("\n[1/5] Ingesting multi-asset market data (Gold, DXY, Equities, VIX, Commodities)...")
    ...
    print("\n[2/5] Ingesting FRED macroeconomic series (Real Yields, Treasuries, HY OAS)...")
    ...
    print("\n[3/5] Ingesting CFTC Commitments of Traders (COT) Gold Positioning...")
    ...
    # 4. ETF Flows
    print("\n[4/5] Ingesting Gold ETF Flows (GLD, IAU)...")
    ...
    print("\n[5/5] Ingesting & normalizing macroeconomic event calendar...")
